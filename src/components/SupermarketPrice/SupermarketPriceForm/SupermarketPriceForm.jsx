...
import {
  ...
  getAll,
  update,
} from '../../../store/actions/supermarketPriceActions';
  ...
  useEffect(() => {
    if (supermarketPriceState.selectedSupermarketPrice._id) {
      ...
      setSuperMarketPriceID(
        supermarketPriceState.selectedSupermarketPrice.superMarketPriceID
      );
      ...
      setYesterdayPrice(
        supermarketPriceState.selectedSupermarketPrice.yesterDayPrice
      );
      ...
      <div className="col-lg-12">
        <div className="item">
          <h5 className="modal-title fw-bold">
            Supermarkets prices in Sri Lanka
          </h5>
          <div className="row">
          ...
          <form id="superMarketPriceForm">
            ...
            <div className="row mt-4">
              <div className="d-flex justify-content-around align-items-center">
                ...
                <button
                  type="button"
                  className="btn btnUpdate btn-secondary"
                  onClick={() => {
                    handleUpdateSubmit();
                  }}
                >
